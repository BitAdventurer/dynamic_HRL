...
parser.add_argument("--epochs", default=100000, type=int, help="Classifier train epochs")
parser.add_argument("--patience", default=10000, type=int, help="Early stop point")
...
parser.add_argument('--epsilon', default=0.15, type=float, help='epsilon-greedy exploration rate')
...
parser.add_argument('--macro_in_dim', default=128, type=int, help='Macro input dim (ensemble/ablation: try 64, 128)')
parser.add_argument('--micro_in_dim', default=128, type=int, help='Micro input dim (ensemble/ablation: try 64, 128)')
parser.add_argument('--rl_hidden_dim', default=128, type=int, help='RL hidden dim')
parser.add_argument('--rl_embed_dim', default=128, type=int, help='RL embed dim')
parser.add_argument('--rl_target_update_freq', default=1, type=int, help='RL target update freq')
parser.add_argument('--buffer_capacity', default=100000, type=int, help='Replay buffer capacity')
parser.add_argument('--rl_batch_size', default=1, type=int, help='RL batch size')
